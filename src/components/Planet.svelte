...
<style lang="scss">
  ...
  :root {
    ...
    --venus-day: 5832.5;
    --venus-color: #e8cda2;
    --earth-image: url(../assets/planets/earth.webp);
    --earth-tilt: rotate(23.26deg);
    --earth-day: 23.9;
    --earth-color: #b3caff;
    --mars-image: url(../assets/planets/mars.webp);
    --mars-tilt: rotate(25.2deg);
    --mars-day: 24.6;
    --mars-color: #c07158;
    --jupiter-image: url(../assets/planets/jupiter.webp);
    ...
    --uranus-day: 17.2;
    --uranus-color: #b8d8e1;
    --neptune-image: url(../assets/planets/neptune.webp);
    ...
    --pluto-day: 153.3;
    --pluto-color: #c3b6aa;
    --sun-image: url(../assets/planets/sun-min.webp);
    --sun-tilt: rotate(0deg);
    --sun-day: 80;
    --sun-color: #cc9f4c;
    --moon-image: url(../assets/planets/moon-min.webp);
